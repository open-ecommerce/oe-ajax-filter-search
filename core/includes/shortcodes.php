...
function ajax_filter_search($atts, $content = null) {
    ...
    if ($post_type == '') {
        ...
        $afs_args .= ' post_type="' . $post_type . '" ';
    }
    if ($posts_per_page == '') {
        
    } else {
        $afs_args .= ' posts_per_page="' . $posts_per_page . '" ';
    }
    if ($category_slug == '') {
        
    } else {
        $afs_args .= ' category_slug="' . $category_slug . '" ';
    }
    if ($filter_by == '') {
        
    } else {
        $afs_args .= ' filter_by="' . $filter_by . '" ';
    }
    if ($offset == '') {
        
    } else {
        $afs_args .= ' offset="' . $offset . '" ';
    }
    ...
    $text .= '												<input type="hidden" class="form-control" name="categorySlug" value="'.$category_slug.'">';
...
function afs_feed($atts, $content = null) {
    ...
    if ($offset != 0) {
        $offset = ($offset - 1) * $posts_per_page;
    }
    if ($posts_per_page == '') {
