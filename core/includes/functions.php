...
if (!function_exists('my_action_callback')) {
    ...
    function my_action_callback() {
        ...
        echo do_shortcode('[afs_feed post_type="' . $post_type . '" posts_per_page="' . $posts_per_page . '" offset="' . $offset . '" filter_type="' . $filter_type . '" filter_by="' . $filter_by . '"]');
